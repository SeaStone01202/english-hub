...
DROP TABLE IF EXISTS public.ip_tracking_events CASCADE;
...
CREATE TABLE public.ip_tracking_events (
...
CREATE INDEX idx_ip_tracking_events_user_created ON public.ip_tracking_events(user_id, created_at DESC);
CREATE INDEX idx_ip_tracking_events_ip_created ON public.ip_tracking_events(ip_address, created_at DESC);
CREATE INDEX idx_ip_tracking_events_type_created ON public.ip_tracking_events(event_type, created_at DESC);
